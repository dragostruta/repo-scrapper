...
[`docs/decisions.md`](docs/decisions.md) has the long version of each, written
...
local embedding model. The golden set asserts recall@2, so a change that
quietly makes retrieval worse fails the build.
